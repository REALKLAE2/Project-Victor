|As a...  |I want to...  |So that / because...|
|--|--|--|
...
|Lecturer |Aid my students when they err so I can guide their learning.| Students can learn from their mistakes without becoming discouraged. |
|Lecturer |Add more and different topics as my class covers a wide range of subjects.| The course can remain relevant and comprehensive. |
|High-achieving student |Access content of higher difficulty so my time is spent learning and challenging myself.| I can continue developing beyond the standard curriculum. |
|Lecturer |Coordinate tests and learning goals within my class so assessments are manageable and aligned.| Testing is efficient and supports course objectives. |
